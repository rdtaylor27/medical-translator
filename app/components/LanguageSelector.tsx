    ...
    <div className="space-y-1.5 sm:space-y-2.5">
      ...
      <div className="relative">
        <select
          ...
          className="w-full bg-white/50 backdrop-blur-md border border-white/60 rounded-xl pl-3 sm:pl-4 pr-10 sm:pr-12 py-2 sm:py-3 text-sm sm:text-base font-medium appearance-none cursor-pointer transition-all duration-300 hover:bg-white/60 hover:border-white/80 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-0 text-slate-800 shadow-sm"
        >
        ...
        <div className="absolute right-8 sm:right-10 top-1/2 -translate-y-1/2 pointer-events-none text-base sm:text-xl">
